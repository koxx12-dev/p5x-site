...
const thiefOverrides = defineCollection({
    ...
    transform: (data) => {
        ...
        return {
            ...
            ...data,
            awareness:
                data.awareness !== undefined && data.awareness !== null
                ? data.awareness.map((a) => ({
                      ...a,
                      name: a.name === undefined ? `awareness.${a.id}.name` : a.name,
                      description: a.description === undefined ? `awareness.${a.id}.description` : a.description,
                  }))
                : data.awareness,
            skill:
                ...
                ? data.skill.map((s) => ({
                      ...
                      description: s.description === undefined ? `skill.${s.id}.description` : s.description,
                  }))
                : data.skill,
            },
        };
...
const thieves = defineCollection({
    ...
    transform: (data) => {
        ...
        return {
            ...
            awareness: data.awareness !== undefined
            ? data.awareness.map((a) => ({
                ...a,
                name: a.name === undefined ? `awareness.${a.id}.name` : a.name,
                description: a.description === undefined ? `awareness.${a.id}.description` : a.description,
