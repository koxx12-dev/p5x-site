	...
	compoundVariants: [
		{
			intent: 'primary',
			scheme: 'default',
			class: ['bg-red-700', 'dark:bg-zinc-800/60'],
		},
		{
			intent: 'secondary',
			scheme: 'default',
			class: ['bg-red-800', 'dark:bg-black/40'],
		},
		{
			intent: 'primary',
			scheme: 'velvet',
			class: ['bg-blue-700', 'dark:bg-zinc-800/60'],
		},
		{
			intent: 'secondary',
			scheme: 'velvet',
			class: ['bg-blue-800', 'dark:bg-black/40'],
		},
		{
			intent: 'primary',
			scheme: 'tartarus',
			class: ['bg-green-700', 'dark:bg-zinc-800/60'],
		},
		{
			intent: 'secondary',
			scheme: 'tartarus',
			class: ['bg-green-800', 'dark:bg-black/40'],
		},
	],
	defaultVariants: {
		intent: 'primary',
